...
public class VacunasFacadeREST extends AbstractFacade<Vacunas> {
    ...
    @PersistenceContext(unitName = "VacunasRestPU")
    private EntityManager em;

    private VacunasPK getPrimaryKey(PathSegment pathSegment) {
        /*
         * pathSemgent represents a URI path segment and any associated matrix parameters.
         * URI path part is supposed to be in form of 'somePath;idVacuna=idVacunaValue;nroDosis=nroDosisValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        com.VacunasPK key = new com.VacunasPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.VacunasPK key = getPrimaryKey(id);
