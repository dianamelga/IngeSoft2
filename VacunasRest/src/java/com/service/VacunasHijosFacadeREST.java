...
import com.Vacunas;
import com.VacunasHijos;
import com.VacunasHijosPK;
...
public class VacunasHijosFacadeREST extends AbstractFacade<VacunasHijos> {
    ...
    private VacunasHijosPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.VacunasHijosPK key = new com.VacunasHijosPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.VacunasHijosPK key = getPrimaryKey(id);
